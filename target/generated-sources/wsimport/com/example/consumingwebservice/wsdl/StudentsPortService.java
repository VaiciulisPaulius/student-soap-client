 ...
 * 
 */
@WebServiceClient(name = "StudentsPortService", targetNamespace = "http://eif.viko.lt/pv/springsoap/gen", wsdlLocation = "http://localhost:8812/ws/students.wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSPORTSERVICE_QNAME = new QName("http://eif.viko.lt/pv/springsoap/gen", "StudentsPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8812/ws/students.wsdl");
    ...
    public StudentsPort getStudentsPortSoap11() {
        return super.getPort(new QName("http://eif.viko.lt/pv/springsoap/gen", "StudentsPortSoap11"), StudentsPort.class);
    }
    ...
    public StudentsPort getStudentsPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://eif.viko.lt/pv/springsoap/gen", "StudentsPortSoap11"), StudentsPort.class, features);
    }
